...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto animate-fade-in">
      ...
      {/* Centered Scrollable Wrapper preventing top clipping */}
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 text-center">
        <div
          className={`relative z-10 w-full max-w-[calc(100vw-1.5rem)] ${maxWidthClasses[maxWidth]} bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col max-h-[82vh] sm:max-h-[85vh] overflow-hidden text-left my-auto`}
