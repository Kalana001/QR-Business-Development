-- ============================================================================
-- QR Business Catalog — Premium Background Customization System Migration
-- Migration for 12 SaaS-grade background styles with clean-premium default
-- ============================================================================

CREATE TABLE IF NOT EXISTS public.catalog_theme_settings (
  business_id UUID PRIMARY KEY REFERENCES public.businesses(id) ON DELETE CASCADE,
  template_id TEXT NOT NULL DEFAULT 'minimal-clean',
  background_style TEXT NOT NULL DEFAULT 'clean-premium',
...
ALTER TABLE public.catalog_theme_settings ADD COLUMN IF NOT EXISTS background_style TEXT NOT NULL DEFAULT 'clean-premium';
ALTER TABLE public.catalog_theme_settings ALTER COLUMN background_style SET DEFAULT 'clean-premium';
